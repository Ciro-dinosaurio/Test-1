...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725725138);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725725138);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725748594);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725597042);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725725138);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1725597072);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725725138);
...
user_pref("browser.contextual-services.contextId", "{560eb410-0103-47b6-8003-46ec2e0d264b}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{dbb6b7d9-ce6b-457f-bd65-1f9ae539c801}");
...
user_pref("browser.startup.lastColdStartupCheck", 1725748564);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECA1kaesoMFlcBAhbPaObYoM5pQ==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"edeabfd4-5cce-4daf-b012-326bfd128845\",\"pictureinpicture@mozilla.org\":\"b95ba421-7dac-4629-a5a4-49de2a1ecbbd\",\"screenshots@mozilla.org\":\"15ecf2f2-c646-446f-928f-8f581abdb760\",\"webcompat-reporter@mozilla.org\":\"15aff2d4-7f16-40cc-8d91-aec395627225\",\"webcompat@mozilla.org\":\"b78b9159-fd44-432a-bf8b-f8a1cb9b5890\",\"default-theme@mozilla.org\":\"652188f4-f204-426c-a075-bd7c9ccaa388\",\"addons-search-detection@mozilla.com\":\"5bba504d-cf9c-414e-8e55-e0c961d6d874\"}");
...
user_pref("media.gmp-manager.lastCheck", 1725725133);
user_pref("media.gmp-manager.lastEmptyCheck", 1725725133);
...
user_pref("security.sandbox.content.tempDirSuffix", "52dd862d-64b6-491b-abec-3c7537f87231");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECE0nVOypL0m9BAicilTTpvHVhA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1725748563);
