...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725588050);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725588050);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725588050);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725588050);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725588050);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1725588080);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725588050);
...
user_pref("browser.contextual-services.contextId", "{b873ecc4-d326-4e42-8050-fa0d5c11d60d}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{bba6b2f7-2eb7-4864-982a-5d3504bad0bc}");
...
user_pref("browser.startup.lastColdStartupCheck", 1725588021);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECCtoPaxmdflVBAio8nJJAGP8cA==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"1351f9cb-5c6d-4393-a18e-aae859a64645\",\"pictureinpicture@mozilla.org\":\"381a84e8-c800-4806-8ee8-a1eeb31cbd32\",\"screenshots@mozilla.org\":\"d3e4ccfa-55fd-4854-a0d7-49a22ec9df51\",\"webcompat-reporter@mozilla.org\":\"c1a304d0-1edd-4b86-a56b-44ad4daf9533\",\"webcompat@mozilla.org\":\"1a1184ae-e63f-49fe-be43-d9e0a5a5b3ba\",\"default-theme@mozilla.org\":\"d9d3b5f1-4b68-4a11-80d0-8ff1c63a4a23\",\"addons-search-detection@mozilla.com\":\"5fe6e55b-5db7-47fe-9063-b757eac3e81c\"}");
...
user_pref("media.gmp-manager.lastCheck", 1725588046);
user_pref("media.gmp-manager.lastEmptyCheck", 1725588046);
...
user_pref("security.sandbox.content.tempDirSuffix", "0dc382b6-97ee-4b0d-833f-48f063245537");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECK3puhYOYqSpBAiw5iSN//piuQ==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1725588019);
